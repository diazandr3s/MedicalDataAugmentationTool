...
class MainLoop(MainLoopBase):
    def __init__(self, cv, modality, path_weights):
        super().__init__()
...
# For MRI images:
#path_weights = './mmwhs_localization/mr_1/2019-08-06_00-05-42/weights/model-20000'

# For CTA images:
path_weights = './mmwhs_localization/ct_1/2019-08-06_00-05-42/weights/model-20000'

object_mainLoop = MainLoop(1,'ct', path_weights)
